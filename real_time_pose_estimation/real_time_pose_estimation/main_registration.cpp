...
string tutorial_path2 = "../"; // path to tutorial

string img_path = tutorial_path2 + "Data/resized_IMG_3875.JPG";  // image to register
string ply_read_path = tutorial_path2 + "Data/box.ply";          // object mesh
string write_path = tutorial_path2 + "Data/cookies_ORB.yml";     // output file
